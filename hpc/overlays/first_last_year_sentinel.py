...
def parse_year_from_mask(path):
    ...
    Handles two formats:
      sacramento_32_2018_01_01_2018_12_31_mask.tif -> 2018  (Jones/Zou masks) #AKA EVAN'S CODE
      sacramento_32_2018_omni_mask.tif -> 2018              (OmniWaterMask) #AKA SAM'S CODE
    """
    # Try omni mask pattern first
    match = re.search(r'_(\d{4})_omni_mask', path.stem)
    if match:
        return int(match.group(1))
    # Fall back to Jones/Zou mask pattern
